...
const Trainingv2 = (props) => {
    ...
    // const [actualMultiSeries, setActualMultiSeries] = useState(training.multi_series[0])
    // const [actualSingleSeries, setActualSingleSeries] = useState(training.multi_series[0].single_series[0])
        ...
        <div className="training__top">
            <div className="training__top__previousexercise">
                ...
                <div
                    ...
                    {/*{typeof training.training[series - 1] !== "undefined" && training.training[series - 1].exercise.name}*/}
                </div>
            </div>
