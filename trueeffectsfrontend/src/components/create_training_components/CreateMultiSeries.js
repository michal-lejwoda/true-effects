    ...
    return (
        <form className="create-series create-training__create-series" onSubmit={handleSubmit}>
            ...
            <div className="inputs create-series__inputs">
                ...
                <div className="inputs__button">
                    <button className="standard-button" onClick={addToSingleSeries}>{t("Add single series")}</button>
                </div>
                ...
                <div className="inputs__button">
                    <button className="standard-button" onClick={addMultiSingleSeries}>{t("Add a few series")}</button>
                </div>
            </div>
        </form>
    );
